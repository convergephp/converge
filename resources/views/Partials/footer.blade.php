    ...
    <div class="">
        ...
        <div
            ...
            <div class="mb-10 col-span-full lg:col-span-2 lg:mb-0">
                ...
                {{-- BRAND --}}
                <a href="https://converge.dev/" class="flex justify-center lg:justify-start">
                    <x-converge::logo />
                </a>
            ...
            <div class="text-left lg:mx-auto ">
                <h4 class="text-lg font-medium text-gray-900 mb-7">
                    Converge</h4>
            ...
            <!--End Col-->
            <div class="text-left lg:mx-auto">
                <h4 class="text-lg font-medium text-gray-900 mb-7">Blogs
                </h4>
                <ul class="text-sm transition-all duration-500">
        ...
        {{-- SUB-FOOTER --}}
        <div class="border-t border-slate-500/10 py-7">
            <div class="flex flex-col items-center justify-center lg:justify-between lg:flex-row">
                <span class="text-sm text-gray-500 ">©<a href="https://pagedone.io/">converge</a> 2025,
                ...
                <div class="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
                    <a href="javascript:;"
                        class="flex items-center justify-center bg-gray-700 rounded-full w-9 h-9 hover:bg-indigo-600">
