<x-converge::page>
    <div class="relative flex items-center">
        {{-- TOP-RIGHT  --}}
        <div
            class="fixed right-[10%] -top-48 h-[400px] w-[90%] rotate-[20deg] rounded-full bg-indigo-500/[0.08] pointer-events-none shadow-[50px_50px_40px_3px] shadow-cyan-500/5 blur-2xl" style="
