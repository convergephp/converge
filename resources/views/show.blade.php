...
<x-converge::page>
    <div x-data="codeBlockClipboard"
        class="z-10 text-sm lg:text-base leading-8 prose max-w-none min-w-[320px] md:min-w-[576px] lg:min-w-[630px] lg:max-w-screen-sm 2xl:max-w-screen-md dark:prose-invert content
