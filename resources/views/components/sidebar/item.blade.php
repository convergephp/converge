...
<li class="scroll-m-4 first:scroll-m-20 text-white">
    <a class="group/mini-link focus:outline-primary dark:focus:outline-primary-light group mt-2 flex cursor-pointer items-center space-x-3  py-1.5 pr-3 text-gray-700  hover:text-gray-900 lg:ml-4 lg:mt-0  dark:text-gray-400 dark:hover:text-gray-300 before:rotate-45 before:scale-0 before:rounded-sm before:bg-primary before:opacity-0 before:transition before:duration-200  hover:before:scale-100 hover:before:opacity-100 dark:before:bg-primary "
        href="{{ $url }}">
