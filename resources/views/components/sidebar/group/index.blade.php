...
<li
    ...
    <button class="text-base-content flex w-full items-center p-2 text-base font-semibold transition duration-75"
    ...
    <ul class="ml-2 space-y-1 border-l p-0" style="border-color: rgba(128, 128, 128, 0.2)" x-show="isOpen"
