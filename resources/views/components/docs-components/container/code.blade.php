...
@endphp
<div data-name="frame"
     {{ $attributes->merge(['class' => 'not-prose text-sm bg-base-300/20 leading-8 relative overflow-hidden rounded-lg border-2 border-gray-400/10  p-1 [&_pre]:!mb-0 [&_pre]:!mt-0 [&_pre]:!rounded-lg mb-4 [&_pre]:!py-2 [&_pre]:!px-4 [&_pre]:!overflow-auto [&_pre]:!ring [&_pre]:!ring-gray-400/20']) }}>
