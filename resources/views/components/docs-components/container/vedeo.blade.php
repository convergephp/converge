<!-- ====== Video Section Start -->
<section x-data="{ videoOpen: false, videoSrc: '' }"
         class="bg-transparent">
    <div class="container mx-auto">
        <div class="-mx-4 flex flex-wrap justify-center">
            <div class="w-full px-4">
                <div class="relative z-20 h-[300px] overflow-hidden rounded-lg md:h-[450px]">
                    <div class="absolute left-0 top-0 h-full w-full">
                        <img src="https://cdn.tailgrids.com/2.0/image/marketing/images/videos/image-02.jpg"
                             alt="image"
                             class="h-full w-full object-cover object-center" />
                    </div>
                    <div
                         class="absolute left-0 top-0 z-10 flex h-full w-full items-center justify-center rounded-2xl bg-transparent bg-opacity-90">
                        <a href="javascript:void(0)"
                           @click="videoOpen = true; videoSrc = 'https://www.youtube.com/embed/LXb3EKWsInQ?autoplay=1' "
                           class="dark:bg-dark-2 text-primary absolute z-20 flex h-20 w-20 items-center justify-center rounded-full bg-white md:h-[100px] md:w-[100px] dark:text-white">
                            <span
                                  class="absolute right-0 top-0 z-[-1] h-full w-full animate-ping rounded-full bg-white bg-opacity-20 delay-300 duration-1000"></span>
                            <svg width="23"
                                 height="27"
                                 viewBox="0 0 23 27"
                                 fill="none"
                    ...
                    <div>
                        <span class="absolute left-4 top-4 z-40">
                            <svg width="50"
                                 height="79"
                                 viewBox="0 0 50 79"
                                 fill="none"
    ...
    <div x-show="videoOpen"
        ...
        <div @click.outside="videoOpen = false; videoSrc=''"
        ...
        <button @click="videoOpen = false; videoSrc='' "
                class="text-body-color absolute right-0 top-0 flex h-20 w-20 cursor-pointer items-center justify-center hover:bg-black">
