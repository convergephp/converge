...
<div 
    ...
    <div>
        <x-converge::dropdown> 
            <x-slot:button class="text-xs leading-5 font-semibold bg-gray-200 hover:opacity-80 transition-all duration-300 dark:bg-white/[0.03] rounded-full py-1 px-3 flex items-center space-x-2 border dark:border-white/15 border-gray-900/15  dark:hover:bg-white/[0.08] text-gray-800 dark:text-gray-200 ">
