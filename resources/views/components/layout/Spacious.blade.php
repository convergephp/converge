     ...
     <div x-data="{ sidebarOpen: false }">
         ...
         <div class="flex min-h-screen">
             ...
             <aside id="logo-sidebar"
                 class="fixed top-0 left-0 z-40 h-screen transition-transform border-r w-72 lg:translate-x-0 bg-base-200 border-base-300"
             ...
             <main class="flex-1 w-full transition-all duration-300 lg:pl-72">
                 <div class="container mx-auto">
                     ...
                     <div class="grid grid-cols-1 xl:grid-cols-[1fr,19rem] gap-8 px-4 lg:px-8 pt-24 pb-12">
                         <div class="max-w-sm gap-10 mx-auto md:max-w-0 xl:flex xl:max-w-7xl">
                             {{-- MAIN CONTENT --}}
                             <div class="flex-grow">
                                 {{ $slot }}
                             </div>
