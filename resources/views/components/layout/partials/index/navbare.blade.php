                       ...
                       <div
                           ...
                           <div class="flex items-center flex-1 gap-x-4">
                               ...
                               <div class="flex items-center gap-x-2">
                                   <button type="button" id="radix-:Rcarcql6:" aria-haspopup="menu"
                                       aria-expanded="false" data-state="closed"
                                       class="group bg-background-light dark:bg-background-dark disabled:pointer-events-none [&amp;>span]:line-clamp-1 overflow-hidden group outline-none group-hover:text-gray-950/70 dark:group-hover:text-white/70 text-xs gap-1.5 text-gray-500 dark:text-gray-400 leading-5 font-semibold border border-gray-200 dark:border-gray-800 hover:border-gray-300 dark:hover:border-gray-700 rounded-full py-1 px-3 flex items-center space-x-2 whitespace-nowrap">v2.x<svg
