<x-converge::layout.base>
    <div class="relative flex flex-col min-h-screen">
        ...
        <div class="lg:flex lg:px-12" x-data="tableOfContents">
            ...
            transition-transform duration-100 top-[7rem] h-[calc(100vh-7.1rem)] w-[19rem]">
            ...
            {{-- CONTENT --}}
            <div class="flex-1 px-5 transition-all duration-100">
                {{ $slot }}
            </div>

            {{-- TABLE OF CONTENT --}}
            <div
                class="hidden sticky my-auto lg:flex flex-col left-0 bottom-0 right-auto border-l border-gray-200/70 dark:border-white/[0.07]
            transition-transform duration-100  top-[7rem] h-[calc(100vh-7.1rem)] w-[22rem]">
