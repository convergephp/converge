<div class="relative rounded-lg pointer-events-auto">
    ...
    <button
        ...
        Quick search...<span class="flex-none pl-3 ml-auto text-xs font-light">Ctrl K</span>
    </button>

    {{-- MOBILE SEARCH BUTTON --}}
    <button
        class="font-light transition-all duration-300 border shadow-xs btn-sm btn lg:hidden btn-square bg-base-300/50 text-base-content hover:bg-base-300 border-base-300">
