<li role="option"
    ...
    <a x-bind:href="result.url"
       @class([
           'justify-start scroll-mt-9 mt-1  group bg-base-300 py-2 px-3 duration-300 border border-transparent w-full transition-colors rounded-lg focus:bg-base-100/60 focus:border focus-visible:outline-none focus:border-primary/20 hover:bg-base-300/60 hover:border-primary/20 hover:border flex justify-between items-center',
           'p-3',
       ])>
