...
class Themes
{
    ...
    public const ICE = [
        ...
        '--color-base-300' => 'oklch(90% 0.001 106.424)',
    ...
    public const SAHRA = [
        ...
        '--color-base-300' => 'oklch(96% 0.067 122.328)',
        '--color-base-content' => 'oklch(42% 0.095 57.708)',
        '--color-primary' => 'oklch(64% 0.246 16.439)',
        '--color-primary-content' => 'oklch(40% 0.101 131.063)',
        '--color-secondary' => 'oklch(89% 0.061 343.231)',
        '--color-secondary-content' => 'oklch(45% 0.187 3.815)',
        '--color-accent' => '#2878ad',
        '--color-accent-content' => 'oklch(47% 0.157 37.304)',
    ...
    public const STRONG = [
        '--color-base-100' => 'oklch(98% 0.003 247.858)',
        '--color-base-200' => 'oklch(93% 0.034 272.788)',
        '--color-base-300' => 'oklch(95% 0.045 203.388)',
        '--color-base-content' => 'oklch(23.574% 0.066 313.189)',
        '--color-primary' => 'oklch(58% 0.158 241.966)',
        '--color-primary-content' => 'oklch(98% 0.002 247.839)',
        '--color-secondary' => 'oklch(89% 0.061 343.231)',
    ...
    public const BLACK = [
        '--color-base-100' => 'oklch(20% 0 0)',
        '--color-base-200' => '#021526',
        '--color-base-300' => '#17153B',
        '--color-base-content' => '#F6F4F0',
        '--color-primary' => '#F93827',
        '--color-primary-content' => '#F6F4F0',
