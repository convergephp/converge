...
class SidebarItemsStyles
{
    ...
    public const STYLE4 = [
        'baseClasses' => 'group/mini-link  group  w-full mt-1 rounded-full  flex  cursor-pointer items-center  space-x-3 py-2 px-2  text-base-content  hover:bg-primary/10 duration-200',
